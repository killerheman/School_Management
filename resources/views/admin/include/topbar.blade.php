        ...
        <div class="form-group w-100">
          <div class="Typeahead Typeahead--twitterUsers">
            <div class="u-posRelative">
              ...
              <div class="spinner-border Typeahead-spinner" role="status"><span class="sr-only">Welcome</span></div><i class="close-search" data-feather="x"></i>
            </div>
          </div>
        </div>
      </form>
      <div class="header-logo-wrapper col-auto p-0">
        <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="{{asset('adminasset/assets/images/logo/logo.png')}}" alt=""></a></div>
        ...
        <ul class="nav-menus">
          ...
          <li class="cart-nav onhover-dropdown">
            ...
            <ul class="cart-dropdown onhover-show-div">
              ...
              <li class="mt-0">
                <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="{{asset('adminasset/assets/images/ecommerce/01.jpg')}}" alt="">
              ...
              <li class="mt-0">
                <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="{{asset('adminasset/assets/images/ecommerce/03.jpg')}}" alt="">
                  <div class="media-body"><span>V-Neck Shawl Collar Woman's Solid T-Shirt</span>
                    <p>Yellow(#fcb102)</p>
                    <div class="qty-box">
                      <div class="input-group"><span class="input-group-prepend">
          ...
          <li class="onhover-dropdown"><i data-feather="message-square"></i>
            <ul class="chat-dropdown onhover-show-div">
              ...
              <li>
                <div class="media"><img class="img-fluid rounded-circle me-3" src="{{asset('adminasset/assets/images/user/1.jpg')}}" alt="">
              ...
              <li>
                <div class="media"><img class="img-fluid rounded-circle me-3" src="{{asset('adminasset/assets/images/user/2.jpg')}}" alt="">
                  <div class="status-circle online"></div>
              ...
              <li>
                <div class="media"><img class="img-fluid rounded-circle me-3" src="{{asset('adminasset/assets/images/user/4.jpg')}}" alt="">
          ...
          <li class="profile-nav onhover-dropdown p-0 me-0">
            <div class="media profile-media"><img class="b-r-10" src="{{asset('adminasset/assets/images/dashboard/profile.jpg')}}" alt="">
              <div class="media-body"><span>Himanshu Sharma</span>
